export const services = [
    ...
    },
    {
      ...
      description: "High-quality, nutrient-rich feed tailored to meet your aquaculture needs.",
    },
    {
      image: require('../../assets/india-929719_1280.jpg'),
    ...
    {
        image: require('../../assets/online-8579179_1280.png'),
        title: "Consultation",
        description: "Expert consltation in the best practices in catfish farming",
      },
  ];
  ...
  export const consultations = [
    ...
    },
    {
      ...
      title: "Catfish Hatching",
      description: "Comprehensive guidance on efficient and successful catfish hatching processes.",
    },
    {
      image: require('../../assets/india-929719_1280.jpg'),
      title: "Catfish Table Size Production",
      description: "Strategies to optimize production for large, market-ready catfish.",
    },
    {
      image: require('../../assets/download (5).jpg'),
      title: "Feed Production",
  ...
  export const trainings = [
    {
      ...
      description: "Master the art of cultivating Black Soldier Flies for sustainable protein production.",
      link: "/trainings/black-soldier-fly-production",
    },
    {
      icon: "🐟",
      title: "Catfish Hatching",
      description: "Comprehensive training on techniques for efficient and successful catfish hatching.",
      link: "/trainings/catfish-hatching",
    },
    {
      icon: "🎣",
      title: "Fish Stocking",
      description: "Learn the best practices for stocking fish to ensure optimal growth and yield.",
      link: "/trainings/fish-stocking",
    },
    {
      icon: "👥",
      title: "Special Focus Group Training",
      description: "Tailored training for specific groups focusing on aquaculture innovations.",
      link: "/trainings/focus-group-training",
    },
    {
      icon: "💻",
      title: "IT in Aquaculture",
      description: "Explore the role of technology in aquaculture, including software and hardware solutions.",
      link: "/trainings/it-in-aquaculture",
    },
    {
        icon: "💻",
        title: "One on one Aquaculture",
        description: "Explore personal training in aquaculture",
        link: "/trainings/it-in-aquaculture",
      },
  ];
  ...
  export const cooperatives = [
    ...
    {
      image: require('../../assets/india-929719_1280.jpg'),
      title: "Anakgazo Training Initiative",
